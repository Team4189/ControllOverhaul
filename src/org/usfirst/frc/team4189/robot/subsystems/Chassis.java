...
public class Chassis extends Subsystem {
	...
	/**
	 * We aren't doing any logic with these numbers, currently,
	 * 		just printing to the dashboard
	 * the block inside the try/catch block seems like it would print a more stable 
	 ...
	 * 
    	...
    	try {
			...
			SmartDashboard.putNumber("Object Width: ", pkt.Width);
			}
